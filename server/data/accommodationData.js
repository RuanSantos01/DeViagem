...
export const minasgeraisAccommodations = [
    {
        ...
        descricao: ' Localizado em Belo Horizonte, o Normandy Hotel dispõe de um restaurante e um business center. A propriedade está situada em frente ao complexo da Igreja de São José.',
        camas: '1 cama de casal',
        avaliacao: '7,1',
        tempoCapacidade: '1 noite, 2 adultos',
        informacoesAdicionais: ['Animais de estimação permitidos', 'Acesso Wi-Fi gratuito', 'Ar Condicionado', 'Casa de banho privativa', 'Recepção disponível 24 horas', 'Cartão de acesso', 'Cofre', 'Sala para Bagagem'],
...
export const alagoasAccommodations = [
    ...
    },
    {
        ...
        descricao: 'Com uma banheira de hidromassagem e um centro de fitness, Maceió Atlantic Suites está situado em Ponta Verde, no Estado do Maceió, 5 km do Museu Théo Brandão. Os hóspedes têm à sua disposição um restaurante no local. Existe estacionamento privado no local.' +
            'Cada quarto climatizado deste hotel está equipado com uma televisão de ecrã plano. Os extras incluem produtos de higiene pessoal gratuitos e um secador de cabelo. Maceió Atlantic Suites  dispõe de acesso Wi-Fi gratuito em toda a propriedade.' +
            'A propriedade providencia uma recepção aberta 24 horas.' +
            'O aeroporto mais próximo é o Aeroporto Internacional Zumbi dos Palmares, a 24 km da propriedade.',
        camas: '1 cama de casal',
        avaliacao: '4,6',
...
export const bahiaAccommodations = [
    {
        ...
        descricao: 'O Cana Brava All Inclusive Resort é a escolha perfeita para viajantes a negócios que pretendem aproveitar o lazer que a cidade oferece. Sua instalações atendem as exigências de todos que buscam um bom lugar para relaxar e trabalhar.Localizado Ilhéus, o Cana Brava All Inclusive Resort consegue se colocar a poucos minutos do centro e ao mesmo tempo próximo dos principais pontos turísticos da cidade.O resort ainda oferece room service 24h, Internet com e sem fio grátis, tv a cabo, serviço de praia, business center, sala de ginástica, piscina e sauna.O hotel oferece shuttle para os dois aeroportos gratuitamente',
        camas: '1 cama de casal',
        avaliacao: '5,9',
    ...
    // ------------- 2 hotel
    {
        ...
        descricao: 'Com uma banheira de hidromassagem e um centro de fitness, Porto Seguro Praia Resort está situado em Porto Segur, no Estado da Bahia, Localizado em frente à praia. Os hóspedes têm à sua disposição um restaurante no local. Existe estacionamento privado no local.' +
            'Cada quarto climatizado deste hotel está equipado com uma televisão de ecrã plano. Os extras incluem produtos de higiene pessoal gratuitos e um secador de cabelo. Porto Seguro Praia Resort dispõe de acesso Wi-Fi gratuito em toda a propriedade.' +
            'A propriedade providencia uma recepção aberta 24 horas.' +
            '4 km da vida noturna na Passarela do Álcool.',
        camas: '1 cama de casal',
        avaliacao: '8,6',
        tempoCapacidade: '4 noite, 2 adultos',
        informacoesAdicionais: ['Não aceita animais de estimação', 'Acesso Wi-Fi gratuito', 'Ar Condicionado', 'Spa', 'Recepção disponível 24 horas', 'Cartão de acesso', 'Sauna', 'Sala para Bagagem', 'Sala de jogos'],
        valor: 1800,
        identificador: 2,
...
export const paranaAccommodations = [
    {
        ...
        quartos: [{
            ...
            localizacao: 'Parana, Foz do Iguaçu',
            tipoQuarto: 'king',
            capacidade: '1 Adultos',
            valor: 1000,
            adicional: 'Meia Pensão',
            id: 2
        }],
        descricao: 'O Hotel Colonial Iguaçu é a escolha perfeita para viajantes a negócios que pretendem aproveitar o lazer que a cidade oferece. Sua instalações atendem as exigências de todos que buscam um bom lugar para relaxar.Localizado Foz do Iguaçu , o hotel consegue se colocar a poucos minutos do centro e ao mesmo tempo próximo dos principais pontos turísticos da cidade.O hotel ainda oferece room service 24h, Internet com e sem fio grátis, tv a cabo,  business center, sala de ginástica, piscina e sauna.',
        camas: '1 cama de casal',
        avaliacao: '7,9',
    ...
    // ------------- 2 hotel
    {
        ...
        descricao: 'Com uma banheira de hidromassagem e um centro de fitness, Rafain Palace Hotel & Convention está situado em Foz do Iguaçu, no Estado da parana, Localizado 20 km das Cataratas do Iguaçu. Os hóspedes têm à sua disposição um restaurante no local. Existe estacionamento privado no local.' +
            'Cada quarto climatizado deste hotel está equipado com uma televisão de ecrã plano. Os extras incluem produtos de higiene pessoal gratuitos e um secador de cabelo. Rafain Palace Hotel & Convention dispõe de acesso Wi-Fi gratuito em toda a propriedade.' +
            'A propriedade providencia uma recepção aberta 24 horas.' +
            '9 km do Zoológico Bosque Guarani e 20 km das Cataratas do Iguaçu.',
        camas: '1 cama de casal',
        avaliacao: '5,6',
        tempoCapacidade: '3 noite, 2 adultos',
...
export const saoPauloAccommodations = [
    {
        ...
        descricao: 'O Bourbon Convention é a escolha perfeita para viajantes a negócios que pretendem aproveitar o lazer que a cidade oferece. Sua instalações atendem as exigências de todos que buscam um bom lugar para relaxar.Localizado São Paulo, o hotel consegue se colocar a poucos minutos do centro e ao mesmo tempo próximo dos principais pontos turísticos da cidade.O hotel ainda oferece room service 24h, Internet com e sem fio grátis, tv a cabo,  business center, sala de ginástica, piscina e sauna.',
        camas: '1 cama de casal',
        avaliacao: '6,9',
        tempoCapacidade: '3 noite, 2 adultos',
        informacoesAdicionais: ['Acesso Wi-Fi gratuito', 'Não aceita animais de estimação', ' frigobar', 'Estacionamento', 'Recepção disponível 24 horas', 'Piscina', 'Cofre', 'Sala para Bagagem'],
    ...
    // ------------- 2 hotel
    {
        ...
        descricao: 'Com uma banheira de hidromassagem e um centro de fitness,Hotel Slaviero Downtown São Paulo está situado na República, no Estado da São paulo, Localizado centro da cidade. Os hóspedes têm à sua disposição um restaurante no local. Existe estacionamento privado no local.' +
            'Cada quarto climatizado deste hotel está equipado com uma televisão de ecrã plano. Os extras incluem produtos de higiene pessoal gratuitos e um secador de cabelo. Hotel Slaviero Downtown São Paulo dispõe de acesso Wi-Fi gratuito em toda a propriedade.' +
            'A propriedade providencia uma recepção aberta 24 horas.' +
            '8 km do Parque Ibirapuera.',
        camas: '1 cama de casal',
        avaliacao: '6,6',
        tempoCapacidade: '1 noite, 2 adultos',
        informacoesAdicionais: ['Não aceita animais de estimação', 'É proibido fumar na propriedade', 'Acesso Wi-Fi gratuito', 'Loja de conveniência', 'Ar Condicionado', 'Spa', 'Recepção disponível 24 horas', 'Cartão de acesso', 'Sauna', 'Sala para Bagagem', 'Sala de jogos'],
...
export const pernambucoAccommodations = [
    {
        ...
        descricao: 'Idealmente localizado em uma das regiões mais privilegiadas de Recife, o Fity Hotel fica no bairro de Boa Viagem, a poucos quarteirões da praia e a 1 km do Shopping Recife. Você vai encontrar diversas opções de restaurantes e compras a uma curta caminhada. ',
        camas: '1 cama de casal',
        avaliacao: '7,5',
        tempoCapacidade: '1 noite, 2 adultos',
        informacoesAdicionais: ['Animais de estimação permitidos', 'Acesso Wi-Fi gratuito', 'Ar Condicionado', 'Casa de banho privativa', 'Recepção disponível 24 horas', 'Cartão de acesso', 'Cofre', 'Sala para Bagagem'],
    ...
    },
    {
        ...
        quartos: [{
            ...
            capacidade: '4 Adultos',
            valor: 250,
            adicional: 'Café da manha',
            id: 2
        }],
        descricao: 'O Park Hotel está a 100 metros da Praia de Boa Viagem, em Pernambuco. Situado próximo a vários restaurantes, o hotel oferece piscina com vista panorâmica do mar. Um buffet de café da manhã variado é servido diariamente.',
        camas: '1 cama de casal',
        avaliacao: '7,9',
        tempoCapacidade: '4 adultos',
        informacoesAdicionais: ['Animais de estimação permitidos', 'Acesso Wi-Fi gratuito', 'Ar Condicionado', 'Casa de banho privativa', 'Recepção disponível 24 horas', 'Cartão de acesso', 'Cofre', 'Sala para Bagagem'],
        valor: 250,
        identificador: 2,
...
export const rondoniaAccommodations = [
    {
        ...
        descricao: 'Os quartos do Oscar Executive Hotel são sofisticados e contam com TVs LCD, frigobar e telefone. Alguns quartos oferecem luxo adicional, tais como TVs LCD de 52", banheira de hidromassagem e área de estar.',
        camas: '1 cama de casal',
        avaliacao: '7,9',
        tempoCapacidade: '1 noite, 2 adultos',
        informacoesAdicionais: ['Animais de estimação permitidos', 'Acesso Wi-Fi gratuito', 'Ar Condicionado', 'Casa de banho privativa', 'Recepção disponível 24 horas', 'Cartão de acesso', 'Cofre', 'Sala para Bagagem'],
    ...
    },
    {
        ...
        descricao: 'A Pousada nossa Raízes oferece piscina ao ar livre, jardim, lounge compartilhado e terraço em Porto Velho. A propriedade oferece cozinha compartilhada, serviço de quarto e Wi-Fi gratuito em todas as áreas. A acomodação dispõe de recepção 24 horas e depósito para bagagem.',
        camas: '1 cama de casal',
        avaliacao: '7,1',
        tempoCapacidade: '1 noite, 2 adultos',
        informacoesAdicionais: ['Animais de estimação permitidos', 'Acesso Wi-Fi gratuito', 'Ar Condicionado', 'Casa de banho privativa', 'Recepção disponível 24 horas', 'Cartão de acesso', 'Cofre', 'Sala para Bagagem'],
...
export const sergipeAccommodations = [
    {
        ...
        descricao: 'O DM HOTEL in Propriá oferece acomodações 3 estrelas com bar. Este hotel 3 estrelas dispõe de terraço e quartos com ar-condicionado, Wi-Fi gratuito e banheiro privativo.',
        camas: '1 cama de casal',
        avaliacao: '7,9',
        tempoCapacidade: '1 noite, 2 adultos',
        informacoesAdicionais: ['Animais de estimação permitidos', 'Acesso Wi-Fi gratuito', 'Ar Condicionado', 'Casa de banho privativa', 'Recepção disponível 24 horas', 'Cartão de acesso', 'Cofre', 'Sala para Bagagem'],
    ...
    },
    {
        ...
        descricao: 'O Hotel Barreto é uma propriedade 3 estrelas situada em Nossa Senhora da Glória. A propriedade oferece restaurante, lounge compartilhado, serviço de quarto e Wi-Fi gratuito.',
        camas: '1 cama de casal',
        avaliacao: '7,0',
        tempoCapacidade: '1 noite, 2 adultos',
        informacoesAdicionais: ['Animais de estimação permitidos', 'Acesso Wi-Fi gratuito', 'Ar Condicionado', 'Casa de banho privativa', 'Recepção disponível 24 horas', 'Cartão de acesso', 'Cofre', 'Sala para Bagagem'],
